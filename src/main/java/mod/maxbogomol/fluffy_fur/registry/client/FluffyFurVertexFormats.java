...
public class FluffyFurVertexFormats {
    ...
    public static final VertexFormatElement AMPLIFIER_DISTORTED = new VertexFormatElement(2, VertexFormatElement.Type.FLOAT, VertexFormatElement.Usage.GENERIC, 1);
    public static final VertexFormatElement OFFSET_DISTORTED = new VertexFormatElement(3, VertexFormatElement.Type.FLOAT, VertexFormatElement.Usage.GENERIC, 1);
    ...
    public static final VertexFormat ADDITIVE_DISTORTED = new VertexFormat(ImmutableMap.<String, VertexFormatElement>builder()
            ...
            .put("UVCap", UV_CAP_DISTORTED).put("Time", TIME_DISTORTED).put("Amplifier", AMPLIFIER_DISTORTED).put("Offset", OFFSET_DISTORTED).build());
