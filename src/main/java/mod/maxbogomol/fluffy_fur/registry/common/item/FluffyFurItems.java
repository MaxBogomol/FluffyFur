...
public class FluffyFurItems {
    ...
    public static final RegistryObject<Item> SILLY_TREAT = ITEMS.register("silly_treat", () -> new Item(new Item.Properties().rarity(Rarity.UNCOMMON).food(FluffyFurFoods.SILLY_TREAT)));
