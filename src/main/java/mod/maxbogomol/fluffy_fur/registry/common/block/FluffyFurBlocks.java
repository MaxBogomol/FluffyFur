...
public class FluffyFurBlocks {
    ...
    public static final RegistryObject<Block> FIRCH_PLUSH = BLOCKS.register("firch_plush", () -> new PlushBlock(BlockBehaviour.Properties.copy(Blocks.WHITE_WOOL).mapColor(MapColor.TERRACOTTA_YELLOW).noOcclusion()));
    ...
    public static final RegistryObject<Block> DARK_PRINCE_PLUSH = BLOCKS.register("dark_prince_plush", () -> new PlushBlock(BlockBehaviour.Properties.copy(Blocks.WHITE_WOOL).mapColor(MapColor.TERRACOTTA_BLACK).noOcclusion()));
    public static final RegistryObject<Block> RALSEI_PLUSH = BLOCKS.register("ralsei_plush", () -> new PlushBlock(BlockBehaviour.Properties.copy(Blocks.WHITE_WOOL).mapColor(MapColor.TERRACOTTA_WHITE).noOcclusion()));
    ...
    public static class RegistryEvents {
        ...
        public static void registerBlocks(FMLCommonSetupEvent event) {
            ...
            PlushBlock.foxSoundPlush.add(FIRCH_PLUSH.get());
