...
public class FluffyFurBlockEntities {
    ...
    public static final RegistryObject<BlockEntityType<PlushBlockEntity>> PLUSH = BLOCK_ENTITIES.register("plush", () -> BlockEntityType.Builder.of(PlushBlockEntity::new,
            FluffyFurBlocks.MAXBOGOMOL_PLUSH.get(), FluffyFurBlocks.ONIXTHECAT_PLUSH.get(), FluffyFurBlocks.UNOLOGICALSAMSAR_PLUSH.get(), FluffyFurBlocks.FOXAIRPLANE_PLUSH.get(), FluffyFurBlocks.SAMMYSEMICOLON_PLUSH.get(), FluffyFurBlocks.BOYKISSER_PLUSH.get(), FluffyFurBlocks.NANACHI_PLUSH.get(), FluffyFurBlocks.SPECKLE_PLUSH.get())
            .build(null));
