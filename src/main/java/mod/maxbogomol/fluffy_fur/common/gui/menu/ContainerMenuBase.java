...
public class ContainerMenuBase extends AbstractContainerMenu {
    ...
    public ItemStack quickMoveStack(Player player, int index) {
        ...
        if (index < VANILLA_FIRST_SLOT_INDEX + VANILLA_SLOT_COUNT) {
            if (!moveItemStackTo(sourceStack, INVENTORY_FIRST_SLOT_INDEX, INVENTORY_FIRST_SLOT_INDEX + getInventorySize(), false)) {
                return ItemStack.EMPTY;
            }
        } else if (index < INVENTORY_FIRST_SLOT_INDEX + getInventorySize()) {
