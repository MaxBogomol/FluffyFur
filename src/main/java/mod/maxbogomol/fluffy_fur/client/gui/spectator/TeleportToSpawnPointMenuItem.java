...
public class TeleportToSpawnPointMenuItem implements SpectatorMenuItem {
    ...
    public static final Component TELEPORT_TEXT = Component.translatable("gui.spectator_menu.spawn_point_teleport");

    @Override
    public void selectItem(SpectatorMenu menu) {
        FluffyFurPacketHandler.sendToServer(new TeleportToSpawnPointPacket());
    }
    ...
    public void renderIcon(GuiGraphics guiGraphics, float shadeColor, int alpha) {
        guiGraphics.blit(SPECTATOR_LOCATION, 0, 0, 0, 0, 16, 16, 64, 64);
    }
