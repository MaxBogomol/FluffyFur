package mod.maxbogomol.fluffy_fur.client.render.fluid;
...
public class FluidRenderer {
    ...
    public static void renderScaledCuboid(PoseStack matrices, MultiBufferSource buffer, FluidCuboid cube, FluidStack fluid, int color, float offset, int capacity, int light, boolean flipGas) {
        ...
        // draw cuboid
        renderCuboid(matrices, buffer.getBuffer(FluffyFurRenderTypes.TRANSLUCENT_TEXTURE), cube, still, flowing, from, to, color, light, isGas && flipGas);
    }
