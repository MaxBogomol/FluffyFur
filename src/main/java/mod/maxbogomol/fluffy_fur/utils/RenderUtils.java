...
public class RenderUtils {
    ...
    public static final RenderType GLOWING = RenderType.create(
            ...
            RenderType.CompositeState.builder()
                    ...
                    .setLightmapState(new RenderStateShard.LightmapStateShard(false))
                    .setTransparencyState(ADDITIVE_TRANSPARENCY)
                    .setShaderState(new RenderStateShard.ShaderStateShard(FluffyFurClient::getGlowingShader))
                    .createCompositeState(false)
    );
    ...
    public static RenderType GLOWING_PARTICLE = RenderType.create(
            ...
            VertexFormat.Mode.QUADS, 256, true, false,
                    ...
                    .setShaderState(new RenderStateShard.ShaderStateShard(FluffyFurClient::getGlowingParticleShader))
                    .createCompositeState(false));
    ...
    public static RenderType DELAYED_PARTICLE = RenderType.create(
            ...
            RenderType.CompositeState.builder()
                    ...
                    .setTextureState(new RenderStateShard.TextureStateShard(TextureAtlas.LOCATION_PARTICLES, false, false))
                    .setShaderState(new RenderStateShard.ShaderStateShard(FluffyFurClient::getSpriteParticleShader))
                    .createCompositeState(false)
    );
    ...
    public static void startGuiParticle() {
        ...
        RenderSystem.setShader(FluffyFurClient::getGlowingShader);
