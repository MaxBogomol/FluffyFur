...
public class FluffyFurCurios {
    ...
    public static class ClientLoadedOnly {
        public static void init() {
            ...
            CuriosRendererRegistry.register(FluffyFurItems.FIRCH_PLUSH.get(), PlushHeadRenderer::new);
            CuriosRendererRegistry.register(FluffyFurItems.FURRYFOXES_PLUSH.get(), PlushHeadRenderer::new);
